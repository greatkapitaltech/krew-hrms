...
from krew_company_onboarding.models import GSTStateConfig
...
class WizardFlowTests(CompanyFilterTestMixin, TestCase):
    ...
    def tearDown(self):
        ...
        # reason — krew_company_onboarding's own models don't use
    ...
    def test_full_wizard_reaches_active(self):
        ...
        from krew_company_onboarding.wizard_utils import get_bank_details
    ...
    def test_amending_an_active_contract_terminates_old_and_creates_new(self):
        from krew_company_onboarding.models import CompanyContract
