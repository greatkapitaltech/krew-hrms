...
here (not imported from krew_company_onboarding.encryption) since migrations
...
def backfill_masked_account_numbers(apps, schema_editor):
    CompanyBankDetails = apps.get_model("krew_company_onboarding", "CompanyBankDetails")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('krew_company_onboarding', '0008_companybankdetails_masked_account_number'),
    ]
