...
def populate_state_fk(apps, schema_editor):
    CompanyStateRegistration = apps.get_model("krew_company_onboarding", "CompanyStateRegistration")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('krew_company_onboarding', '0017_companystateregistration_add_state_fk'),
    ]
