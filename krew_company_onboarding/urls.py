"""
krew_company_onboarding/urls.py

Mounted at "company-onboarding/" by krew_company_onboarding/apps.py's ready()
...
from krew_company_onboarding.cbv import bank_verification, status, wizard
