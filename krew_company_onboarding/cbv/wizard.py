"""
krew_company_onboarding/cbv/wizard.py
...
from krew_company_onboarding.forms import (
...
from krew_company_onboarding.models import (
    CompanyBankDetails,
...
from krew_company_onboarding.wizard_utils import (
...
class Step3View(View):
    ...
    def get(self, request, company_id):
        if not (
            ...
            or request.user.has_perm("krew_company_onboarding.add_companybrandedtemplate")
            or request.user.has_perm("krew_company_onboarding.add_companydocument")
        ):
    ...
    def post(self, request, company_id):
        ...
        if action in ("upload_template", "upload_document"):
            required_perm = (
                "krew_company_onboarding.add_companybrandedtemplate"
                if action == "upload_template"
                else "krew_company_onboarding.add_companydocument"
            )
